    ...
    <div class="container">
          ...
          <div class="col-12 col-md-3">
            <div class="blog-categories">
              <livewire:isite::filters :filters="['categories' => [
                                                                ...
                                                                'isExpanded' => true,
                                                                'type' => 'tree',
                                                                'repository' => 'Imagina\Icrud\Repositories\CategoryRepository',
                                                                'entityClass' => 'Imagina\Icrud\Entities\Category',
        ...
        <div class="blog-related mb-5">
          ...
          <x-isite::carousel.owl-carousel
            id="Articles"
            repository="Imagina\Icrud\Repositories\PostRepository"
